...
// Para animar cada pata del modelo agregamos 
...
float dogBody = 0.0f;    // cuerpo del modelo 
...
typedef struct _frame {
	...
	// Variables de movimiento de patas traseras
	float BRightLeg;
	float BRightLegInc;
	...
	// Variables de movimiento de patas delanteras
	float FRightLeg;
	float FRightLegInc;
	...
	// Variables de movimiento de la cola
	float tail;
	float tailInc;

	// Variables de movimiento del cuerpo
	float dogBody;
	float dogBodyInc;
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 12  Valeria Ramirez", nullptr, nullptr);
...
void DoMovement()
{
	...
	// Movimiento de pata derecha delantera
	if (keys[GLFW_KEY_6])
	{
	...
	// Movimiento de pata izquierda delantera
	if (keys[GLFW_KEY_8])
	{
	...
	// Movimiento de pata trasera derecha
	if (keys[GLFW_KEY_0])
	{
	...
	//// Movimiento de pata trasera izquierda
	if (keys[GLFW_KEY_P])
	{
