...
// Previo 05
// Fecha de entrega: 05 / Septiembre / 2025
// No. Cuenta: 318063188
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 05   Valeria Ramirez", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(muneca), glm::vec3(0.0f, 1.0, 0.0f)); //muneca
